...
public class ClientCreationResponsePojo {
    public int clientID;
    ...
    public ClientCreationResponsePojo(String firstName, String lastNameOrCompany, String email, String persCodeOrRegNumber) {
